...
public static class Assets
{
    ...
    public static void LoadAssets()
    {
        ...
        AchievementPopUp = Addressables.LoadAssetAsync<GameObject>("Assets/UltraAchievementsCore/Achievement Overlay.prefab").WaitForCompletion().GetComponent<AchievementPopUp>();
        AchievementPanel = Addressables.LoadAssetAsync<GameObject>("Assets/UltraAchievementsCore/Achievement Panel.prefab").WaitForCompletion().GetComponent<AchievementPanel>();
    }
}